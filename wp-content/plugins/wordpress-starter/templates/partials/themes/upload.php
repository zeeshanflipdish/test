<div class="sg-tabs_content sg-container sg-container--elevation-1 sg-with-padding sg-with-padding--padding-top-none sg-with-padding--padding-right-none sg-with-padding--padding-bottom-none sg-with-padding--padding-left-none sg-tab-upload" >
	<form method="post" enctype="multipart/form-data" class="wp-upload-form" action="<?php echo self_admin_url( 'update.php?action=upload-theme' ); ?>">
		<div class="sg-grid sg-grid--gap-medium sg-grid--autoflow-row sg-grid--sm-12 sg-with-padding sg-with-padding--padding-top-responsive sg-with-padding--padding-right-responsive sg-with-padding--padding-bottom-responsive sg-with-padding--padding-left-responsive presentation-box">
			...
			<div class="sg-grid-column--sm-span-10">
				<h3 class="sg-title sg-title--density-cozy sg-title--level-3 sg-with-color sg-with-color--color-darkest sg-typography sg-typography--weight-bold">
					<?php _e( 'Upload Your Theme', 'siteground-wizard' ); ?>
				</h3>
				<p class="sg-text sg-text--size-medium sg-with-color sg-with-color--color-dark sg-typography sg-typography--weight-regular sg-upload-label">
					<?php _e( 'If you have a theme in a .zip format, you may install it by uploading it here.', 'siteground-wizard' ); ?>
				</p>

				<div class="sg-grid sg-grid--autoflow-row sg-grid--gap-x-small sg-upload-result"></div>
		...
		<div class="sg-toolbar sg-toolbar--background-light sg-toolbar--density-cozy sg-toolbar--align-center sg-toolbar--justify-flex-end sg-toolbar--direction-row">
			<div class="sg-grid--sm-4">
				...
				<label for="themezip" class="sg-ripple-container sg-button sg-button--neutral sg-button--medium">
					<span class="sg-button__content"><?php _e( 'Choose file', 'siteground-wizard' ); ?></span>
				</label>
                <button class="sg-ripple-container sg-button sg-button--primary sg-button--medium sg-button--disabled" id="install-button-submit" name="install-button-submit">
                    <span class="sg-button__content">
                        <?php _e( 'Install Now', 'siteground-wizard' ); ?>
                    </span>
                </button>
				<input type="file" id="themezip" name="themezip" accept=".zip"  style="display: none;"/>
			</div>
		</div>
	</form>
